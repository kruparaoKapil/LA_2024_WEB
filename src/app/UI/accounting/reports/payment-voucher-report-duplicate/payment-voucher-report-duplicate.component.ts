...
@Component({
  selector: 'app-payment-voucher-report-duplicate',
  templateUrl: './payment-voucher-report-duplicate.component.html',
  styles: []
})
export class PaymentVoucherReportDuplicateComponent implements OnInit {
