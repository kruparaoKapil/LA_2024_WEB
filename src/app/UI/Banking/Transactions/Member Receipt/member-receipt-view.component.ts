...
export class MemberReceiptViewComponent implements OnInit {
  ...
  savebutton = "Show"
  constructor(private fb: FormBuilder,private _commonservice:CommonService, private _MemberReceiptService: MemberReceiptService, private datepipe: DatePipe) {
  ...
  BindData() {
    ...
    let gridEffectfromdate = this.datepipe.transform(this.MemberREceiptViewForm.controls.pFromDate.value, "dd-MM-yyyy");
    let gridEffectToDate = this.datepipe.transform(this.MemberREceiptViewForm.controls.pTodate.value, "dd-MM-yyyy");
