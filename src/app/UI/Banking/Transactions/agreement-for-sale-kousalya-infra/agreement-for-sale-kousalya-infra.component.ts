...
@Component({
  selector: 'app-agreement-for-sale-kousalya-infra',
  templateUrl: './agreement-for-sale-kousalya-infra.component.html',
  styles: []
})

export class AgreementForSaleKousalyaInfraComponent implements OnInit {
  pcompany_name: any;
  plocation: any;
  pcin: any;
  page: any = '50';
