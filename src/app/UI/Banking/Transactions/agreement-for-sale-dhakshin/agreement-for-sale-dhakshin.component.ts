...
@Component({
  selector: 'app-agreement-for-sale-dhakshin',
  templateUrl: './agreement-for-sale-dhakshin.component.html',
  styles: []
})

export class AgreementForSaleDhakshinComponent implements OnInit {
  pcompany_name :any;
  plocation :any;
  pcin :any;
  page :any = '50';
