...
@Component({
  selector: 'app-loan-closure-certificate',
  templateUrl: './loan-closure-certificate.component.html',
  styleUrls: ['./loan-closure-certificate.component.css']
})
export class LoanClosureCertificateComponent implements OnInit {
