...
@Component({
  selector: 'app-foreclosure-prepayment-request-letter',
  templateUrl: './foreclosure-prepayment-request-letter.component.html',
  styleUrls: ['./foreclosure-prepayment-request-letter.component.css']
})
export class ForeclosurePrepaymentRequestLetterComponent implements OnInit {
