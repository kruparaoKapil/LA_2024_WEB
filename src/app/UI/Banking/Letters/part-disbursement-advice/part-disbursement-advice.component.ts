...
@Component({
  selector: 'app-part-disbursement-advice',
  templateUrl: './part-disbursement-advice.component.html',
  styleUrls: ['./part-disbursement-advice.component.css']
})
export class PartDisbursementAdviceComponent implements OnInit {
