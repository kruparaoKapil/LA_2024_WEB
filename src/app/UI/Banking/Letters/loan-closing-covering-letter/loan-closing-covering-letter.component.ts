...
@Component({
  selector: 'app-loan-closing-covering-letter',
  templateUrl: './loan-closing-covering-letter.component.html',
  styleUrls: ['./loan-closing-covering-letter.component.css']
})
export class LoanClosingCoveringLetterComponent implements OnInit {
