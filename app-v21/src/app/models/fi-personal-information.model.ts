...
export interface ApplicationPersonalEmployeementModel {
  ...
  preportingto?: string;
  pemployeeexp?: number | string;
  pemployeeexptype?: string;
  ptotalworkexp?: number | string;
...
export interface ApplicationbusinessactivityModel {
  ...
  pestablishmentdate?: Date | string;
  pcommencementdate?: Date | string;
  pcinnumber?: string;
  pgstinno?: string;
  pCreatedby?: number;
  pModifiedby?: number;
