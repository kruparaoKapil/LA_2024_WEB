...
@Component({
  selector: 'app-journal-voucher-report-duplicate',
  templateUrl: './journal-voucher-report-duplicate.component.html',
  styles: []
})

export class JournalVoucherReportDuplicateComponent implements OnInit {
